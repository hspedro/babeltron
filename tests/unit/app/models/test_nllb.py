...
from babeltron.app.models.nllb import NLLBTranslationModel, ModelArchitecture, get_translation_model


class TestNLLBTranslationModel:
    @pytest.fixture(autouse=True)
    def mock_torch(self):
        with patch("babeltron.app.models.nllb.torch") as mock_torch:
    ...
    def mock_transformers(self):
        with patch("babeltron.app.models.nllb.AutoModelForSeq2SeqLM") as mock_model:
            with patch("babeltron.app.models.nllb.AutoTokenizer") as mock_tokenizer:
    ...
    @patch("babeltron.app.models.nllb.get_model_path")
...
def test_get_translation_model():
    with patch("babeltron.app.models.nllb.NLLBTranslationModel.load", return_value=(None, None, None)):
