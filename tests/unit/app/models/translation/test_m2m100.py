...
from babeltron.app.models.translation.m2m100 import M2M100TranslationModel, ModelArchitecture, get_translation_model


class TestM2M100TranslationModel:
    @pytest.fixture(autouse=True)
    def mock_torch(self):
        with patch("babeltron.app.models.translation.m2m100.torch") as mock_torch:
    ...
    def mock_transformers(self):
        with patch("babeltron.app.models.translation.m2m100.M2M100ForConditionalGeneration") as mock_model:
            with patch("babeltron.app.models.translation.m2m100.M2M100Tokenizer") as mock_tokenizer:
    ...
    @patch("babeltron.app.models.translation.m2m100.get_model_path")
...
def test_get_translation_model():
    with patch("babeltron.app.models.translation.m2m100.M2M100TranslationModel.load", return_value=(None, None, None)):
